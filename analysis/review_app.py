...
with tab_review:
    ...
    with uv_mc[1]: st.metric("🟢 Reviewer Included",   int(_uv_vc.get("include", 0)))
    with uv_mc[2]: st.metric("🟠 Reviewer Unsure",     int(_uv_vc.get("unsure",  0)))
    with uv_mc[3]: st.metric("🔴 Reviewer Excluded",   int(_uv_vc.get("exclude", 0)))
